  ...
  return (
    <div className="max-w-sm overflow-hidden">
      ...
      <div className='mt-4'>
        ...
        {/* Button */}
        <button className="mt-2 px-3 py-1 m-1 rounded-full text-sm bg-[#FFCC00] font-normal hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-600">
        Contribute
        </button>
      </div>
    </div>
